...
function buildEmail(issue) {
  ...
  const editorNote = noteContent ? `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;background:#eef2f6"><tr><td align="center" style="padding:18px 8px 0"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:720px;background:#ffffff;border:1px solid #dde3ea;border-radius:20px;overflow:hidden"><tr><td class="r25-pad" style="padding:28px 24px;color:#344054;font-family:Arial,sans-serif;font-size:17px;line-height:1.7"><p style="margin:0 0 14px;color:#168fc8;font-family:Courier New,monospace;font-size:13px;font-weight:bold;letter-spacing:1px;text-transform:uppercase">From the editor</p>${noteContent}</td></tr></table></td></tr></table>` : "";
  ...
  return { subject: issue.title, preheader: senderPreheader(issue), content, canonicalUrl };
}
